...
power operations on $E$-cohomology, which contradicts a claim in the literature 
known to experts.  
  ...
  \begin{split}
   d_\T = & -w_0^{\T - 1} w_\T - \sum_{n = 0}^{\T - 2} 
          ...
          & \qquad\qquad\qquad\qquad\, \sum_{\stackrel{\scriptstyle m_{1,r} 
            ...
            w_{m_{1,r}} \cdots w_{m_{\T - r - (n - r + 1),r}} \Bigg) \hskip 2cm
  \end{split}
 \end{equation*}
 \begin{equation*}
  \begin{split}
...
\begin{proof}
 ...
 in $\G$.  By means analogous to the proof of Proposition \ref{prop:Q}, we find 
 that the term $Q_0 Q_1$ has coefficient $w_2$ in the Adem relation for 
 $Q_1 Q_0$ (see Remark \ref{rmk:Adem}).  Near the cusps, since $p | w_i$ for 
 $2 \leq i \leq p$ according to \eqref{A0} and \eqref{Ai}, we then compute by 
 Proposition \ref{prop:Q} that 
 \begin{equation*}
  \begin{split}
