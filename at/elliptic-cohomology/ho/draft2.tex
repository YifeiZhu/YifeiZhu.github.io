...
cohomology operations by Baker \cite{Baker90,Baker89}, Ando \cite{Ando95}, and 
Ganter \cite{stringy,moonshine,orbifold}, among others.  The various cohomology 
  ...
  \begin{equation*}
   \begin{split}
    ...
    Q_5(x y) = & ~ \big( Q_0(x) Q_5(y) + Q_1(x) Q_4(y) + Q_2(x) Q_3(y) + Q_3(x) Q_2(y) \\
               ...
               & + (h + 9450) Q_5(x) Q_5(y) \qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad\qquad
   \end{split}
  \end{equation*}
